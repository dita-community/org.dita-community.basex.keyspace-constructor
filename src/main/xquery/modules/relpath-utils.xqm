(: =====================================================
   ...
   NOTE: This copy has a different namespace to make deployment
   easier.
   ===================================================== :)
   
module namespace relpath="http://dita-community.org/basex/keyspace/xquery/module/relpath-utils";
